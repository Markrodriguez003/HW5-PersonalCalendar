    ...
    function pageLoad() {
        ...
        for (var i = 0; i < DAY_HOURS; i++) { // Loops through all of Hours of the day and sets blocks per index
            ...
            $(`.rowBlock${i}`)
                ...
                .addClass(`btn btn-sm deleteEntryBtn yesEntryBtn${i} col-1 bg-success text-white`); // Creates yes btn
            $(`.rowBlock${i}`)
                ...
                .addClass(`btn btn-sm deleteEntryBtn noEntryBtn${i} col-1 bg-danger text-white`); // Creates no btn
            $(`.rowBlock${i}`)
                ...
                .addClass(`col-1 col-offset-2 btn saveBtn saveBtn${i} pageBtn`); // Creates save btn
            $(`.rowBlock${i}`)
                ...
                .find("button:last")
                .addClass(`col-1 btn clearBtn clearBtn${i} pageBtn`); // Creates clear btn which triggers yes/no btns above
        }
    }
